...
import lupusTexture from '~/assets/lupus.png';
import lagunitasTexture from '~/assets/lagunitas.png';
  ...
  return (
    <div className={styles.home}>
      ...
      <ProjectSummary
        ...
        index={2}
        title="Lagunitas Brewing Company Reimagined"
        description="A conceptual redesign exploring a bold, modern visual identity for Lagunitas through typography, layout, and product-focused composition."
